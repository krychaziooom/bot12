...
client.on('message', msg => {
  ...
  if(cmd == "infobot"){
    ...
    .setDescription("BOTA STWORZYŁ Krycha#1432. WERSJA BOTA TO v1.2")
    .setColor(0xFF7F00)
  ...
  if(cmd == "youtube"){
    ...
    .setTitle("YOUTUBE")
    .setDescription("https://www.youtube.com/channel/UCY_4KNDWQfX_ffcsilA9XJA?view_as=subscriber")
    .setColor(0x001eff)
